...
export default function Home() {
  ...
  return (
    <div className="flex items-center justify-center bg-beige">
      {isAuthenticated&&  <div className=" absolute top-4 right-4 z-20 text-center">
              <button  onClick={handleLogOut} className="text-sm bg-white py-1 px-4 rounded-md font-bold text-gray-500 hover:text-gray-600">
               LOGOUT
              </button>
            </div>}
